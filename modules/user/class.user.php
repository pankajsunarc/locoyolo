...
//$tokenMetadata->validateUserId('123');
		   ...
		   if ($exist){
			...
			<div>
					...
					<p>Thank you for registering on LocoYolo.
					Your temporary password for account '.$email.' is locoyolo@123. Please change it.
					</p>
...
function editprofile()
{
    ...
    require_once(ROOTPATH.'/lib/image_manipulator.php');
    ...
    if($err =='') {
        ...
        $message = '<div style="border:#EFEFEF 1px solid; background:#FBFFEC; padding:3px; border-radius:3px; margin:0 auto"><font class="ArialOrange18" style="font-size:15px">Your details have been updated</font></div><br>';
...
//        return false;
    ...
    function signUp()
    {
        ...
        if (strlen($frmdata["password1"]) <8) {
            $err .= "Please enter password of at least 8 characters.<br>";
        }
...
//                $candidate_name = $DB->SelectRecords('public_users', 'id =' . $id, 'user_id,firstname,lastname,email');
//
