...
$query = "SELECT * from events where event_lat > '$SWlat' and event_lat <  '$NElat' and event_long < '$NElng' and event_long > '$SWlng' and start_time >= '$start_time' and end_time <= '$end_time' and start_date =  '$event_date'";
...
$stmt = "SELECT * from events where event_lat > '$SWlat' and event_lat < '$NElat' and event_long < '$NElng' and event_long > '$SWlng' and start_time >= '$start_time' and end_time <= '$end_time' and start_date = '$event_date' LIMIT $offset, $rowsperpage";
